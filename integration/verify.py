...
def test_resource(owncloud_session_domain, user_domain, device_host):
...
def test_admin(owncloud_session_domain, user_domain, device_host):
    session, _ = owncloud_session_domain
...
def __check_test_dir(owncloud_session, test_dir, user_domain, device_host):
